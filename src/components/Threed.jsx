...
Command: npx gltfjsx@6.5.0 threed.gltf --transform 
Files: threed.gltf [191.41KB] > C:\Users\AsH23\OneDrive\Desktop\threed\threed-transformed.glb [65.54KB] (66%)
...
export default function Threed(props) {
  ...
  const { nodes, materials, animations } = useGLTF("/threed-transformed.glb");
